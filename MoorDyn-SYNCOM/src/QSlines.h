...
int Catenary(double XF, double ZF, double L, double EA, double W, double CB, double Tol, double* HFout, double* VFout, 
		double* HAout, double* VAout, int Nnodes, vector<double>& s, vector<double>& X, vector<double>& Z, vector<double>& Te)
